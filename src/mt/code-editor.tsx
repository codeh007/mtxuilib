...
export function CodeEditor({
  ...
  return (
    <div className={cn(className, "w-full h-fit relative rounded-lg overflow-hidden")}>
      <Editor
        ...
        options={{
          ...
          lineNumbers: lineNumbers ? (lineNumber) => `<span style="padding-right:8px">${lineNumber}</span>` : "off",
          theme: editorTheme,
      ...
      />
      {copy && <CopyToClipboard className="absolute top-1 right-1" text={code?.trim()} />}
    </div>
  );
}
