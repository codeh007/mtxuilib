...
function ErrorFallback({ error, resetErrorBoundary }: ErrorFallbackProps) {
  ...
  return (
    <div data-slot="app-error-boundary" className="flex items-center justify-center min-h-screen bg-background p-4">
 ...
 */
export function AppErrorBoundary({ children, onError, onReset }: AppErrorBoundaryProps) {
  return (
