...
export function Headline({ heading, text, children, className, layout, size, ...props }: HeadlineProps) {
  return (
    <div data-slot="headline" className={cn(headlineVariants({ layout }), className)} {...props}>
