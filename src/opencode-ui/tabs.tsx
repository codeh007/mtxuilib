...
function TabsList({ className, ...props }: TabsListProps) {
  return <TabsPrimitive.List {...props} data-slot="tabs-list" className={className} />;
}
...
function TabsTrigger({
  ...
  return (
    ...
    >
      <TabsPrimitive.Trigger {...props} data-slot="tabs-trigger" className={cn("group/tab", classes?.button)}>
        {children}
...
function TabsContent({ className, children, ...props }: TabsContentProps) {
  return (
    <TabsPrimitive.Content {...props} data-slot="tabs-content" className={className}>
      {children}
