...
function getImageSrc({ base64, mediaType }: Pick<GeneratedImageLike, "base64" | "mediaType">) {
  if (base64 && mediaType) {
...
export const Image = ({ base64, uint8Array, mediaType = "image/png", className, alt, ...props }: ImageProps) => {
